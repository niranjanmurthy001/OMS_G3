...
{
    public partial class Order_History_List : Form
    {
        ...
        public Order_History_List(int userid,int Orderid,string OrderNo,string Clientname,string Subprocessname,string State,string County)
        {
            InitializeComponent();
            Userid = userid;
            Order_ID = Orderid;
