...
namespace Ordermanagement_01.Opp.Opp_CheckList
{
    public partial class CheckLists : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void repositoryItemCheckEdit1_EditValueChanged_1(object sender, EventArgs e)
        {
            gridView1.PostEditor();
            if (gridView1.PostEditor())
            {
        ...
        private void repositoryItemCheckEdit_No_EditValueChanged(object sender, EventArgs e)
        {
            gridView1.PostEditor();
            if (gridView1.PostEditor())
            {
        ...
        private void repositoryItemCheckEdit_Yes_EditValueChanging(object sender, DevExpress.XtraEditors.Controls.ChangingEventArgs e)
        {
           
        }

        private void repositoryItemCheckEdit_Yes_Click(object sender, EventArgs e)
        {           
        }

        private void repositoryItemCheckEdit_No_Click(object sender, EventArgs e)
        {           
        }
