    ...
    public partial class Order_Entry_Old : Form
    {
      ...
      //  }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Order_Id == 0)
            {
                ...
                if (dt_Maxid.Rows.Count > 0)
                {
                    ...
                    Order_Uploads_Old Orderuploads = new Order_Uploads_Old("Insert", Orderno, userid, txt_OrderNumber.Text, ddl_ClientName.SelectedValue.ToString(), ddl_SubProcess.SelectedValue.ToString());
                    Orderuploads.Show();
                }
            }
            else
            {
                ...
                Order_Uploads_Old Orderuploads = new Order_Uploads_Old("Update", Order_Id, userid, txt_OrderNumber.Text, ddl_ClientName.SelectedValue.ToString(), ddl_SubProcess.SelectedValue.ToString());
                Orderuploads.Show();
            }
        }
        ...
        private void btn_Order_Notes_Click(object sender, EventArgs e)
        {
            ...
            Ordermanagement_01.Employee.Employee_Order_Information emp = new Ordermanagement_01.Employee.Employee_Order_Information(userid, State_ID, Order_Id, userroleid,0,0);
            emp.Show();
        }
