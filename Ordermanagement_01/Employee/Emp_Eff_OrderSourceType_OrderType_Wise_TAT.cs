...
{
    public partial class Emp_Eff_OrderSourceType_OrderType_Wise_TAT : Form
    {
        ...
        public Emp_Eff_OrderSourceType_OrderType_Wise_TAT(string Username, int User_id)
        {
            InitializeComponent();
            user_ID = User_id;
            User_Name = Username;
        }
        private void Emp_Eff_OrderSourceType_OrderType_Wise_TAT_Load(object sender, EventArgs e)
        {
            dbc.Emp_BindOrderSourceType(Column1);
            dbc.Emp_BindOrderTypeAbbrevation(Column3);
        ...
        private void Grd_OrderSource_and_Order_Type_TAT_EditingControlShowing(object sender, System.Windows.Forms.DataGridViewEditingControlShowingEventArgs e)
        {
        ...
        private void Grd_OrderSource_and_Order_Type_TAT_CellClick(object sender, System.Windows.Forms.DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                if (e.ColumnIndex == 14)
                {
                    ...
                    if (dialog == DialogResult.Yes)
                    {
                        ...
                        dt_Delete = dataaccess.ExecuteSP("SP_Emp_Client_Cat_Sal_Bracket_TAT_Detail", ht_Delete);
        ...
        private void Grd_OrderSource_and_Order_Type_TAT_CellEnter(object sender, System.Windows.Forms.DataGridViewCellEventArgs e)
        {
