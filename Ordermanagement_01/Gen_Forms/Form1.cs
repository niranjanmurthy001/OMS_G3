...
using System.Data;
using Ordermanagement_01;
using Ordermanagement_01.Gen_Forms;
...
namespace Ordermanagement_01.Gen_Forms
{
    ...
    public partial class Form1 : System.Windows.Forms.Form
	{
		...
		TaskbarNotifier taskbarNotifier3=new TaskbarNotifier();							// Added Rev 002
		...
		public Form1()
		{
            ...
            try
            {
                //string folderPath = "D:\\Niranjan 2019\\Ordermanagement_01.A.75\\Ordermanagement_01\\Resources\\skin.bmp";
                //taskbarNotifier1.SetBackgroundBitmap(new Bitmap(GetType(), folderPath), Color.FromArgb(255, 0, 255));
                //taskbarNotifier1.SetBackgroundBitmap(Resources.skin, Color.FromArgb(255, 0, 255));
                //taskbarNotifier1.SetBackgroundBitmap(Resources.skin, Color.FromArgb(255, 0, 255));
                ...
                taskbarNotifier2.SetBackgroundBitmap(Resources.skin2, Color.FromArgb(255, 0, 255));
