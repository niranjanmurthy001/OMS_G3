  ...
  /* [Designer("Cyotek.Windows.Forms.Design.ImageBoxDesigner", Cyotek.Windows.Forms.ImageBox.Design.dll, PublicKeyToken=58daa28b0b2de221")] */ public class ImageBox : VirtualScrollableControl
  {
    ...
    protected override void OnMouseUp(MouseEventArgs e)
    {
      ...
      //{
        ...
        {
            //PosY = this.VerticalScroll.Value + 1;
            //this.UpdateScrollPosition(new Point(posX, PosY));
    ...
    protected override void OnMouseWheel(MouseEventArgs e)
    {
      ...
      //  {
         ...
         if(   e.Delta > 0)
       {
          PosY = this.VerticalScroll.Value - 20;
          this.UpdateScrollPosition(new Point(posX, PosY));
      }
      else
      {
    ...
    public Image GetZoomImage(int X, int Y, int width, int height)
    {
        Image result;
        ...
        rect = this.FitRectangle(new Rectangle(X, Y, Width,Height));
